...
class QiNiuClient(object):
    ...
    def init_app(self, app):
        self.access_key = app.config["QINIU"]["access_key"],
        self.secret_key = app.config["QINIU"]["secret_key"],
        self.bucket_name = app.config["QINIU"]["bucket_name"],
        self.qn_domain_name = app.config["QINIU"]["qn_domain_name"]
